		...
		<div className="min-h-screen bg-gradient-to-br from-red-900 via-red-950 to-red-900 text-white">
			...
			<section className="py-10">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl md:text-2xl text-white/90 font-medium">Transforming Complexity into Clarity</p>
				</div>
			</section>

			<AnimatedSection id="about" className="py-20" delay={0.1}>
				{/* About Me Section */}
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
						<div>
							...
							<p className="text-lg text-gray-200 mb-6 leading-relaxed">
								I am a Manager in Data Analytics and a passionate educator with 12 years of corporate experience at top organizations
								like Abbott, Cipla, and Technicolor Creative Studios, alongside 8 years of teaching experience.
							</p>
							...
							<div className="grid grid-cols-2 gap-8 mb-8">
								<div className="text-center">
									<div className="text-4xl font-bold text-yellow-400 mb-2">4000+</div>
								...
								<div className="text-center">
									...
									<div className="text-gray-300">Corporate projects/consulations</div>
								</div>
								<div className="text-center">
			...
			<AnimatedSection id="college-training" className="py-20 relative overflow-hidden" delay={0.1}>
							...
							<div className="space-y-8">
								...
								<div className="bg-red-900/40 rounded-2xl p-6 backdrop-blur-sm border border-red-800/30">
									<div className="flex items-center mb-6">
										...
										<h3 className="text-xl font-bold text-red-400">Premier Academic Partners</h3>
									</div>
			...
			<AnimatedSection id="courses" className="py-20" delay={0.1}>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-200 max-w-3xl mx-auto">Comprehensive programs designed to take you from beginner to expert</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{[
							...
							>
								...
								<div className="mb-6">
									<h3 className="text-2xl font-bold mb-2 text-yellow-400">{course.title}</h3>
								...
								<Link
									...
									className={`px-4 py-3 rounded-full font-semibold transition-all text-center block ${
										course.popular
			...
			<AnimatedSection id="testimonials" className="py-20 relative overflow-hidden" delay={0.1}>
				{/* Video Background */}
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
						{[
							...
							>
								...
								<div className="text-3xl font-bold text-red-400 mb-2">{stat.result}</div>
			...
			<AnimatedSection id="start" className="py-20" delay={0.1}>
				{/* Start Now Section */}
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
						...
						<div className="bg-red-900/60 border border-red-700/50 rounded-3xl p-8 backdrop-blur-lg shadow-2xl">
							<div className="text-center lg:text-left">
								<h3 className="text-2xl font-bold text-white mb-4">Contact Me Directly</h3>
								...
								<p className="text-red-300 text-sm mt-6">📞 Available for personal consultations | 💬 Quick response guaranteed</p>
							</div>
						</div>

						{/* Right side - Start Journey CTA */}
						<div className="bg-gradient-to-br from-red-800/60 to-red-900/60 border border-red-700/50 rounded-3xl p-8 backdrop-blur-lg shadow-2xl">
							<div className="text-center">
								...
								<Link
									href="https://forms.gle/JrS5NyqdWMvBM46d7"
									className="inline-block bg-white text-red-700 px-10 py-4 rounded-full text-xl font-bold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl mb-6"
								>
					...
					<div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 text-center">
						<h3 className="text-2xl font-bold text-white mb-4">🎁 Limited Time Bonus</h3>
						<p className="text-red-100 mb-4">Enroll in the next 48 hours and get:</p>
			...
			<footer className="bg-gray-900 py-12">
                ...
                >
                  Twitter
						...
						<div>
							<h4 className="text-lg font-semibold text-red-50 mb-4">Quick Links</h4>
						...
						<div>
							<h4 className="text-lg font-semibold text-red-50 mb-4">Contact</h4>
